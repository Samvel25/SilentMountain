					...
					<div className="row justify-content-center">
						<div className="col-lg-10">
							<div className="top-wrapper">
								{/* Introduction */}
								<p>
									This privacy notice for <strong>BabyCheese</strong>{" "}
								...
								<section className="privacy-section">
									...
									<ul>
										<li>
											...
											with BabyCheese and the Services, the choices you make,
											and the products and features you use.{" "}
											<a href="#section1">More details</a>
										</li>
										<li>
											<strong>
										...
										<li>
											...
											<a href="#section2">More details</a>
										</li>
										<li>
											<strong>
								...
								<section className="privacy-section">
									...
									<ol>
										<li className="mb-2 font-weight-bold">
											<a className="link-blue" href="#section1">
												What information do we collect?
											</a>
										</li>
										<li className="mb-2 font-weight-bold">
											<a className="link-blue" href="#section2">
												How do we process your information?
											</a>
										</li>
										<li className="mb-2 font-weight-bold">
											<a className="link-blue" href="#section3">
												What legal bases do we rely on to process your personal
												information?
											</a>
										</li>
										<li className="mb-2 font-weight-bold">
											<a className="link-blue" href="#section4">
												When and with whom do we share your personal
												information?
											</a>
										</li>
										<li className="mb-2 font-weight-bold">
											<a className="link-blue" href="#section5">
												What is our stance on third-party websites?
											</a>
										</li>
										<li className="mb-2 font-weight-bold">
											<a className="link-blue" href="#section6">
												Do we use cookies and other tracking technologies?
											</a>
										</li>
										<li className="mb-2 font-weight-bold">
											<a className="link-blue" href="#section7">
												How long do we keep your information?
											</a>
										</li>
										<li className="mb-2 font-weight-bold">
											<a className="link-blue" href="#section8">
												Do we collect information from minors?
											</a>
										</li>
										<li className="mb-2 font-weight-bold">
											<a className="link-blue" href="#section9">
												What are your privacy rights?
											</a>
										</li>
										<li className="mb-2 font-weight-bold">
											<a className="link-blue" href="#section10">
												Controls for do-not-track features
											</a>
										</li>
										<li className="mb-2 font-weight-bold">
											<a className="link-blue" href="#section11">
								...
								<section id="section1" className="privacy-section">
									...
									<p>
										...
										use, and navigate the Services. This information does not
									...
									<p>
										The information we collect includes, and is not limited to:
									</p>
									<ul>
										<li>
										...
										<li>
											...
											information either by refusing access to information
								...
								<section id="section4" className="privacy-section">
									...
									<ul>
										...
										<li>
											...
											your location. You may revoke your consent anytime by
											contacting us.
										</li>
										<li>
								...
								<section id="section5" className="privacy-section">
									...
									<p>
										...
										parties, including other websites or applications that may
								...
								{/* Section 9 */}
								<section id="section9" className="privacy-section">
									...
									<p>
										...
										communications at any time by contacting us. You will then
								...
								{/* Section 10 */}
								<section id="section10" className="privacy-section">
								...
								{/* Section 11 */}
								<section id="section11" className="privacy-section">
									<h4>
